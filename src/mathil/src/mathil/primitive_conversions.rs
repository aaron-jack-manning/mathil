pub (in crate::mathil) fn f32_to_i32(float : f32) -> i32 {
...
pub (in crate::mathil) fn f32_to_u32(float : f32) -> u32 {
...
pub (in crate::mathil) fn f32_to_u16(float : f32) -> u16 {
...
pub (in crate::mathil) fn i32_to_f32(integer : i32) -> f32 {
...
pub (in crate::mathil) fn u32_to_f32(integer : u32) -> f32 {
    if f64::from(integer) > f64::from(f32::MAX) || f64::from(integer) < f64::from(f32::MIN) {
        panic!("Could not convert due to input being out of bounds of the output type.");
    }
    else {
...
pub (in crate::mathil) fn u8_to_f32(integer : u8) -> f32 {
    if f64::from(integer) > f64::from(f32::MAX) || f64::from(integer) < f64::from(f32::MIN) {
        panic!("Could not convert due to input being out of bounds of the output type.");
    }
    else {
